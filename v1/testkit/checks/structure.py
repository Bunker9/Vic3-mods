...
(Unknown effect/trigger token detection against the CWTools script-docs is a v2 follow-up.)

Usage:
    python structure.py <path-to-mod-folder> [--json <out.json>]
Prints a readable summary; with --json also writes machine-readable results.
"""
