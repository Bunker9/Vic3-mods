...
HERE = os.path.dirname(os.path.abspath(__file__))            # .../testbook/testkit
TB   = os.path.dirname(HERE)                                  # .../testbook  (archive root)
...
def run():
    ...
    render_html.render(branch, mods_static, logdata, mods_human, root_report)
