...
SANITY = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))  # .../sanity-check


def load_props(mod):
    """Read sanity-check/test-<mod>/props.toml; return {} if absent."""
    p = os.path.join(SANITY, f"test-{mod}", "props.toml")
...
def resolve_logs_dir():
    ...
    for base in (os.path.join(os.environ.get("USERPROFILE", ""), "OneDrive", "Dokumen"),
